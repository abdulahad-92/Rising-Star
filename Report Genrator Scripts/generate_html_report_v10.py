    ...
    <body>
        ...
        <div class="container" id="content-to-pdf">
            ...
            <div class="section">
                ...
                <div class="row">
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        <div class="chart-container" id="progressChart">Overall Score: {percentage}%</div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        <div class="chart-container" id="overallPieChart">Answer Distribution: Correct: {correct}, Incorrect: {incorrect}, Skipped: {skipped}</div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="chart-container" id="overallBarChart">Performance Breakdown: Correct: {correct}, Incorrect: {incorrect}, Skipped: {skipped}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="chart-container" id="sectionChart">Section-wise Accuracy: {', '.join([f'{s}: {v["accuracy"]:.2f}%' for s, v in section_stats.items()])}</div>
            </div>
            ...
            <div class="section">
                ...
                <div class="row">
                    {''.join([
                        f'<div class="col-12 col-md-6 col-lg-6 mb-4"><h4>{section}</h4><div class="chart-container" id="topicChart_{section.replace(" ", "_")}">Topics: {", ".join([f"{t}: {stats["accuracy"]:.2f}%" for t, stats in topic_stats[section].items()])}</div></div>'
            ...
            <div class="section">
                ...
                <div class="chart-container strength-weakness-container" id="strengthDonutChart">Strength Distribution: {', '.join(strength_labels)}</div>
                <div class="chart-container strength-weakness-container" id="weakDonutChart">Weak Area Distribution: {', '.join(weak_labels)}</div>
                <div class="chart-container strength-weakness-container" id="radarChart">Strengths vs Weaknesses: {', '.join([f'{s}: {v["accuracy"]:.2f}%' for s, v in section_stats.items()])}</div>
            </div>
        ...
        <script>
            ...
            function downloadPDF() {{
                ...
                const opt = {{
                    ...
                    jsPDF: {{ unit: 'mm', format: [500, 700], orientation: 'portrait' }}
                }};
                ...
                }}, 2000); // Delay to ensure charts render
            }}
        </script>
    </body>
    </html>
