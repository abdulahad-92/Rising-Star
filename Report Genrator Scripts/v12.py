...
def generate_html_report(student_data, questions, metadata, output_dir='reports'):
    ...
    <body>
        ...
        for section in topic_charts.keys()
            ...
            <div class="section">
                ...
                <div class="chart-container" id="strengthDonutChart"></div>
                <div class="chart-container" id="weakDonutChart"></div>
                <div class="chart-container" id="radarChart"></div>
            </div>

            <div class="section tips-section" style="margin-top: 70px;">
    ...
    Chart(Distribution)
    new
    ApexCharts(document.querySelector("#overallPieChart"), {
        chart: {
            type: 'pie',
            height: '100%'
        },
    ...
    Breakdown)
    new
    ApexCharts(document.querySelector("#overallBarChart"), {
        chart: {
            type: 'bar',
            height: '100%'
        },
    ...
    Chart
    new
    ApexCharts(document.querySelector("#sectionChart"), {
        chart: {
            type: 'bar',
            height: '100%'
        },
...
html2pdf().from(element).save('MUET_Entry_Test_Report_{student_id}.pdf');
}
</script>
</body>
</html>
