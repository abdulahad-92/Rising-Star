...
def generate_html_report(student_data, questions, metadata, output_dir='reports'):
    ...
    quotes_list = "".join([f'<p class="quote">{quote}</p>' for quote in selected_quotes])
    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="row">
                    {''.join([
        f'<div class="col-12 col-md-6 mb-4"><h4>{section}</h4><div class="chart-container" id="topicChart_{section.replace(" ", "_")}"></div></div>'
